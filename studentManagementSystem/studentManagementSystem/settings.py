...
SECRET_KEY = "django-insecure-$rn)-=-%cm=@@vuvb%=zvnu@5t3hq9@waf^$6rto2%6o#+c^iy"
...
# Optional: Configure session caching (if needed)
...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": os.path.join(BASE_DIR, "logs/student_management.log"),
            "formatter": "verbose",
        },
        "console": {
            "level": "DEBUG",
